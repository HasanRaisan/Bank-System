...
public:
	...
	enum enSystemDate { eYear = 1, eSecond = 2 };

	clsDate( enSystemDate SystemDate,short Second, short Minute, short Hour)
	{
		_Second = Second;
		_Minute = Minute;
		_Hour = Hour;
	...
	void PrintYearCalendar(clsDate date)
	{
		...
		for (int i = 1; i <= 12; i++)
		{
			PrintMonthCalendar(i, date._Year);
		}
